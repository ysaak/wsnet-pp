...
#define EDThresholdMin        -82     /* radio->mindBm + 10 cf p66 ref 802.15.4-2006 */
#elif OQPSK_2400
#define macMinLIFSPeriod      160000  /* 40 symbols cf p30 ref 802.15.4-2006 */
#define macMinSIFSPeriod      480000  /* 12 symbols cf p30 ref 802.15.4-2006 */
#define aUnitBackoffPeriod    80000   /* 20 symbols cf p159 ref 802.15.4-2006 */
